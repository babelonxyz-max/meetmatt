...
export async function POST(req: NextRequest, context: RouteContext) {
  try {
    ...
    const body = (await req.json()) as TelegramBotPackItemInput;
    const pack = await addTelegramBotPackItem({
      packId,
      item: body,
    });
    ...
    console.error("[Internal/Telegram/Inventory/Packs/:packId/Items] Error:", error);
    return NextResponse.json(
