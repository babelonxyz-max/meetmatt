    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] pt-14">
      ...
      <section className="py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-3 p-1.5 rounded-full bg-[var(--card)] border border-[var(--border)]">
              <button
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {moreStats.map((stat, i) => (
              <motion.div
                ...
                transition={{ delay: i * 0.1 }}
                whileHover={{ y: -4 }}
                className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-5 text-center hover:border-[var(--accent)]/30 transition-all duration-300"
              >
                <div className="text-2xl sm:text-3xl font-bold text-[var(--accent)] mb-1">{stat.value}</div>
