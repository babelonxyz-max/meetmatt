...
interface StepAgentNameProps {
  onSubmit: (name: string) => void;
}

export function StepAgentName({ onSubmit }: StepAgentNameProps) {
    ...
    >
      <div className="mb-8">
        ...
        <p className="text-[var(--muted)]">
          This name will be used by Devin to create your AI agent
        </p>
      </div>
      ...
      <div className="space-y-4">
        <input
          ...
          placeholder="e.g., Jarvis, Friday, Ada, Max"
