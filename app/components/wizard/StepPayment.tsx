...
export function StepPayment({ agentName, onContinue }: StepPaymentProps) {
  ...
  return (
    ...
    >
      ...
      {/* Pricing Card */}
      <div className="bg-gradient-to-br from-[var(--accent)]/20 to-[#6366f1]/20 border border-[var(--accent)]/30 rounded-2xl p-6 mb-6">
      ...
      <button
        onClick={onContinue}
        disabled={!accepted}
        className="w-full p-4 bg-gradient-to-r from-[var(--accent)] to-[#6366f1] hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl font-semibold transition-all flex items-center justify-center gap-2 shadow-lg shadow-[var(--accent)]/25"
      >
