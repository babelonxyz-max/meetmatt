...
export default async function OpsDashboardPage({
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionCard
        eyebrow="Control Map"
        title="Operate Matt by domain"
        description="The old single-page ops surface is still here, but now it is navigable. Use this as the front door to the current Matt domains: overview, money path, relationships, Telegram transport, capability loadouts, platform setup, and warm bot inventory."
      >
